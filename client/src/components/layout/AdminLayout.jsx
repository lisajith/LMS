...
function AdminLayout() {
  ...
  return (
    <div className="h-screen bg-theme flex overflow-hidden">
      {/* Sidebar */}
      <aside
        className="sticky top-0 h-screen w-72 card-theme border-r border-theme
             flex flex-col shadow-lg overflow-y-auto overflow-x-hidden"
      >
        <div className="p-6 flex flex-col min-h-full">
          ...
          {/* User Card */}
          <div className="mt-auto pt-6 border-t border-theme space-y-3">
      ...
      {/* Main Content */}
      <main className="flex-1 bg-theme-secondary h-screen overflow-y-scroll overflow-x-hidden">
        <div className="p-6 lg:p-8 space-y-8 max-w-7xl mx-auto min-h-full">
          <Outlet />
        </div>
      </main>
    </div>
