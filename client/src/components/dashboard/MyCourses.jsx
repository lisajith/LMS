  ...
  return (
    <section>
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          <h2 className="text-3xl font-bold text-theme">My Courses</h2>
      ...
      {courses.length === 0 ? (
        <div className="card-theme rounded-2xl shadow-md border p-10 text-center">
          <FolderOpen size={60} className="mx-auto text-slate-400 mb-5" />

          <h3 className="text-2xl font-bold text-theme">No Enrolled Courses</h3>
