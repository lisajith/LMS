...
function TestResult() {
  ...
  if (loading) {
    return <div className="text-center py-32">Loading Result...</div>;
  }

  if (!submission || !test) {
    return <div className="text-center py-32">Result Not Found</div>;
  }
        ...
        <div className="relative flex flex-col lg:flex-row justify-between items-center gap-8">
          <div className="flex-1 text-center lg:text-left">
            ...
            <p className="text-theme-muted mt-4 text-lg max-w-2xl">
              Your submission has been evaluated successfully. Review your
              performance and question-wise analysis below.
            </p>
        ...
        <div className="card-theme rounded-2xl p-6 border border-theme shadow-lg hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <h2 className="text-4xl font-bold text-red-500 mt-2">{wrong}</h2>

              <p className="text-sm text-theme-muted mt-1">need improvement</p>
            </div>
        ...
        <div className="card-theme rounded-2xl p-6 border border-theme shadow-lg hover:shadow-xl transition-all duration-300">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-theme-muted mt-1">final evaluation</p>
            </div>
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-theme-muted mt-2">
              Compare your answers with the correct answers and identify
              improvement areas.
            </p>
          </div>
      ...
      `}
          ...
          `}
                  ...
                  <div className="text-center lg:text-right min-w-30">
                    ...
                    >
                      {marksEarned}/{Number(question.marks || 1)}
                    </p>
                  </div>
                </div>
              ...
              `}
                ...
                >
                  <div className="flex items-center justify-between gap-4">
                    ...
                    >
                      {isCorrect ? "+" : ""}
                      {marksEarned} Mark{marksEarned !== 1 ? "s" : ""}
                    </div>
                  </div>
                </div>
              </div>
