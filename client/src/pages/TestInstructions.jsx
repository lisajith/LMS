      ...
      <div className="card-theme rounded-3xl p-8 shadow-xl border border-theme">
        ...
        <div className="space-y-4">
          ...
          <div className="space-y-3 text-theme leading-7">
            <div className="flex gap-3">
              ...
              <p>
                Once the test starts, the timer will continue even if you leave
                the page.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <p>
                Do not switch tabs, minimize the browser, or leave the test
            ...
            <div className="flex gap-3">
              ...
              <p>
                You will receive a maximum of <strong>3 warnings</strong> for
            ...
            <div className="flex gap-3">
              ...
              <p>
                ...
                submitted and cannot be resumed.
              </p>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <p>
                Use the Question Navigator to move between questions and review
        ...
        <div className="primary-soft primary-border border rounded-2xl p-5 mt-8">
          <p className="font-semibold primary-text">
            By clicking <strong>Start Test</strong>, you agree to follow all
            exam rules and understand that repeated violations will result in
